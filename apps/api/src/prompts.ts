...
- Keep the learner's intended meaning, including their actions, questions and negations. Repair a mistaken verb instead of deleting the action to avoid the grammar problem: "Ik wil eet soep" becomes "Ik wil soep eten", not just "Ik wil soep". Fix grammar and sentence construction as well as spelling: word order, verb forms, articles, prepositions and agreement. Offer a more natural full phrase when understandable wording is awkward. Distinguish genuine errors from optional style or politeness suggestions in the explanation; do not label a valid short answer as wrong.
