...
export interface paths {
	...
	"/word/recalculate-duplicates": {
		...
		get?: never;
		put?: never;
		/** Trigger duplicate and synonym recalculation for all languages */
		post: operations["WordController_recalculateDuplicates"];
		delete?: never;
		options?: never;
		head?: never;
		patch?: never;
	...
	"/word/synonyms": {
		...
		/** Get paginated synonym groups with full word data */
		get: operations["WordController_getSynonyms"];
		put?: never;
		post?: never;
		delete?: never;
		options?: never;
...
export interface operations {
	...
	WordController_recalculateDuplicates: {
		parameters: {
			query?: never;
			header?: never;
			path?: never;
		...
		requestBody?: never;
		responses: {
			/** @description Recalculation jobs enqueued */
			200: {
				headers: {
					[name: string]: unknown;
				};
